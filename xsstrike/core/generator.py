from .config import xsschecker, badTags, fillings, eFillings, lFillings, jFillings, eventHandlers, tags, functions
from .jsContexter import jsContexter
from .utils import randomUpper as r, genGen, extractScripts
