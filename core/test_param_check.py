...
def test_param_check(payload_to_check, payload_to_compare, OCCURENCE_NUM, url, param_data, method, proxy, action):
    ...
    check_response = make_request(url, param_data_injected, method, proxy)
    success = False
